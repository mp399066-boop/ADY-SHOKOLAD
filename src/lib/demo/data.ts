...
export const DEMO_CUSTOMERS: Customer[] = [
  {
    ...
    מספר_זהות: null, פטור_ממעמ: false,
...
export const DEMO_FINANCE_OVERVIEW = {
  ...
  // How much of each kpi above is delivery fees — included in those totals,
  // shown separately so the composition is visible in the demo too.
  shipping: {
