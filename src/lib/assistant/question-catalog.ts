...
export const QUESTION_CATALOG: CatalogEntry[] = [
  // ── Summary / snapshot ─────────────────────────────────────────────────
  {
    phrases: ['תני סיכום', 'סיכום של היום', 'תני לי סיכום של היום', 'תמונת מצב', 'מה המצב היום', 'איך נראה היום', 'סיכום יומי'],
  ...
  // ── Orders ─────────────────────────────────────────────────────────────
  {
    phrases: ['כמה הזמנות יש היום', 'כמה הזמנות להיום', 'כמה הזמנות יש לי היום'],
    intent: { type: 'count_orders', range: TODAY, filters: {} },
    category: 'orders',
    label: 'כמה הזמנות יש היום?',
  },
  {
    phrases: ['כמה הזמנות יש מחר', 'כמה הזמנות למחר', 'כמה הזמנות יש לי מחר'],
  ...
  {
    phrases: ['הזמנות דחופות', 'הזמנות הדחופות', 'מה הזמנות דחופות', 'תראי לי דחופות', 'מה דחוף היום'],
    intent: { type: 'find_orders', range: TODAY, filters: { urgentOnly: true } },
    category: 'orders',
    label: 'הזמנות דחופות להיום',
  },
  {
    phrases: ['הזמנות שלא שולמו', 'הזמנות לא שולמו', 'הזמנות שלא משולמות', 'מי לא שילם', 'מי עוד לא שילם'],
  ...
  // ── Revenue ────────────────────────────────────────────────────────────
  {
    phrases: ['כמה הכנסתי החודש', 'מה ההכנסות החודש', 'הכנסות החודש', 'מכירות החודש', 'כמה כסף נכנס החודש', 'סך מכירות החודש'],
  ...
  // ── Customers ──────────────────────────────────────────────────────────
  {
    phrases: ['מי הלקוחות הכי פעילים', 'הלקוחות הכי פעילים', 'מי הלקוחות הכי גדולים', 'מי הזמין הכי הרבה', 'לקוחות מובילים', 'לקוחות vip'],
    intent: { type: 'customers_top', scope: MONTH },
    category: 'customers',
    label: 'מי הלקוחות הכי פעילים',
  },
  {
    phrases: ['לקוחות חדשים', 'מי הלקוחות החדשים', 'כמה לקוחות חדשים יש', 'לקוחות שהצטרפו לאחרונה', 'מי נרשם החודש'],
  ...
  // ── Products ───────────────────────────────────────────────────────────
  {
    phrases: ['המוצרים הכי נמכרים', 'מה המוצר הכי פופולרי', 'איזה מוצרים נמכרים הכי הרבה', 'מה הכי נמכר', 'טופ מוצרים', 'מוצרים מובילים'],
  ...
  // ── Inventory ──────────────────────────────────────────────────────────
  {
    phrases: ['מה במלאי נמוך', 'מה חסר במלאי', 'מה אזל', 'מה נגמר', 'חוסרים במלאי', 'מלאי קריטי', 'מה מתקרב לסיום במלאי'],
  ...
  // ── Deliveries ─────────────────────────────────────────────────────────
  {
    phrases: ['משלוחים פתוחים', 'אילו משלוחים פתוחים', 'משלוחים שלא נמסרו', 'משלוחים בדרך', 'משלוחים פעילים', 'מי השליחים', 'איזה משלוחים בדרך'],
  ...
  // ── System / errors ────────────────────────────────────────────────────
  {
    phrases: ['יש שגיאות', 'מה שגיאות', 'תראי לי שגיאות', 'תקלות במערכת', 'מה לא עובד', 'מה נכשל', 'באגים', 'מה השתבש', 'איפה נכשל'],
